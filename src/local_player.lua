...
-- Local Player: walkspeed • infinite jump • fly (IY-like + mobile analog) • esp pemain
...
----------------------------------------------------------------
local _, ijLeft, ijRight = newRow(50); ijLeft.Text = "infinite jump"
local ijBtn=Instance.new("TextButton"); ijBtn.Size=UDim2.new(0,160,0,34); ijBtn.AutoButtonColor=false
...
----------------------------------------------------------------
-- esp pemain (Highlight + nama + jarak) : [ esp pemain ] [ ON/OFF ]
----------------------------------------------------------------
local _, espLeft, espRight = newRow(56); espLeft.Text = "esp pemain"
local espBtn=Instance.new("TextButton"); espBtn.Size=UDim2.new(0,160,0,34); espBtn.AutoButtonColor=false
...
local function addESP(plr)
  ...
  bg.BackgroundTransparency=.25; bg.BackgroundColor3=Theme.card; bg.Size=UDim2.fromScale(1,1)
  corner(bg,6); stroke(bg,Theme.accA,1).Transparency=.2

  local nameL = Instance.new("TextLabel")
  nameL.BackgroundTransparency=1; nameL.Position=UDim2.new(0,6,0,2); nameL.Size=UDim2.new(1,-12,0,18)
  ...
  distL.BackgroundTransparency=1; distL.Position=UDim2.new(0,6,0,18); distL.Size=UDim2.new(1,-12,0,14)
  distL.Font=Enum.Font.Gotham; distL.TextSize=12; distL.TextColor3=Theme.text2
  distL.TextXAlignment=Enum.TextXAlignment.Center; distL.TextTruncate = Enum.TextTruncate.AtEnd
  distL.Parent=bg
...
local function unhookAll()
  for p,cn in pairs(addedConns) do if cn and typeof(cn)=="RBXScriptConnection" then cn:Disconnect() end end
